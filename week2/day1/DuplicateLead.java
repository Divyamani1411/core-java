...
public class DuplicateLead {
	public static void main(String[] args) {
		...
		*/
		...
		elementCompanyName1.sendKeys("java");
		WebElement elementFirstName1 = driver.findElement(By.id("createLeadForm_firstName"));
		elementFirstName1.clear();
		elementFirstName1.sendKeys("Dhanshika");
		WebElement elementCreadLead1= driver.findElement(By.name("submitButton"));
		elementCreadLead1.click();
		System.out.println(driver.getTitle());
